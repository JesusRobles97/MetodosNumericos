...
double funcion(double x) {
    // En este ejemplo, el usuario proporcionará la función
    return x * x;
}

// Método de la regla rectangular por la izquierda
double reglaRectangularIzquierda(double (*f)(double), double a, double b, int n) {
...
int main() {
    ...
    // Aproximación de la integral usando la regla rectangular por la izquierda
    double resultado = reglaRectangularIzquierda(funcion, a, b, n);
